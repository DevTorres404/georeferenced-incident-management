...
use App\Catalogs\Infrastructure\Notifications\OperationalCategoryRequestNotifier;
use App\Catalogs\Infrastructure\Persistence\Repositories\EloquentCatalogProvisioningRepository;
use App\Catalogs\Infrastructure\Persistence\Repositories\EloquentCatalogRepository;
use App\Catalogs\Infrastructure\Persistence\Repositories\EloquentCategoryRequestRepository;
...
use App\Incidents\Infrastructure\Persistence\Repositories\EloquentIncidentCycleReadRepository;
...
use App\Operations\Infrastructure\Persistence\Repositories\EloquentOperatorWorkReportRepository;
...
class AppServiceProvider extends ServiceProvider
{
    ...
    public function register(): void
    {
        ...
        $this->app->bind(CategoryRequestRepositoryInterface::class, EloquentCategoryRequestRepository::class);
        $this->app->bind(CatalogProvisioningPort::class, EloquentCatalogProvisioningRepository::class);
        $this->app->bind(CategoryRequestNotificationPort::class, OperationalCategoryRequestNotifier::class);
        ...
        $this->app->bind(IncidentCycleReadRepositoryInterface::class, EloquentIncidentCycleReadRepository::class);
        ...
        $this->app->bind(OperatorWorkReportRepositoryInterface::class, EloquentOperatorWorkReportRepository::class);
