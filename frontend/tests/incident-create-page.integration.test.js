  ...
  describe('module exports', () => {
    it('exports all expected pure functions', async () => {
      ...
      const expected = [
        ...
        'validateSelect',
        'validateEmail',
        'validateRequiredCoordinatePair',
        'fillSelect',
        'setDisabled',
        'formatFileSize',
        'createClientId',
        ...
        'populateTerritorialProvinces',
        'populateTerritorialLevel',
        'applyReverseGeocode',
        'selectTerritorialFromAddress',
        'setSelectValue',
        ...
        'hydrateContactEmail',
        'updateCounter',
        'setManualTerritoryMode',
        'getManualTerritoryValue',
        'setManualTerritoryValue',
        'buildAddressText',
        'validateLocation',
        'validateEvidence',
        'validateDetails',
