...
\end{tikzpicture}
\caption{Jerarquía territorial (Separación Operativa y Política)}
\end{figure}

\begin{restriccion}[Reglas de validación jerárquica]
\begin{itemize}
  \item Cada tipo de unidad tiene un padre válido específico (ej: Cantón es hijo de Zona Operativa, Provincia es hija directa de País).
  \item La Zona Operativa y la Provincia son ramas paralelas para permitir divisiones operativas independientes de la geopolítica (ej: Guayaquil/Quito).
