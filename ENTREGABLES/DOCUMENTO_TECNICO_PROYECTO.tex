...
frontend. La evidencia de PHPUnit muestra \textbf{252 pruebas superadas},
\textbf{1.503 aserciones} y \textbf{0 fallos}. La ejecución registrada tuvo una
duración de \textbf{512,06 s}.
...
\dosporevidencia
{phpunit.png}{0.96}{Resultado de la suite PHPUnit del backend: 252 pruebas superadas y 1.503 aserciones.}
{vitest.png}{0.96}{Resultado de las pruebas del frontend con Vitest: 54 archivos superados y 1.275 tests aprobados.}
